...
\begin{multicols}{2}
  ...
  Anaylsis of \verb|power.c| shows us that \verb|total_power_cycle_cc1| is calculated as a sum of \verb|rename_power_cc1|, \verb|bpred_power_cc1|, \verb|lsq_power_cc1|, \verb|window_power_cc1|, \verb|regfile_power_cc1|, \verb|icache_power_cc1|, \verb|resultbus_power_cc1|, \verb|clock_power_cc1|, \verb|alu_power_cc1|, \verb|dcache_power_cc1|, and \verb|dcache2_power_cc1|; which does not include \verb|fetch_stage_power_cc1|, \verb|dispatch_stage_power_cc1|, or \verb|issue_stage_power_cc1|. Figure \ref how each of those components contributes to the total:
